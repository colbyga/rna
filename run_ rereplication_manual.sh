...
#SBATCH -c 1
#SBATCH -t 3-0:0:0 
#SBATCH -o /global/project/hpcg1504/rna/logs_gc/gc_run_rereplication2.sh.%A_%a.stdout
#SBATCH -e /global/project/hpcg1504/rna/logs_gc/slurm/gc_run_rereplication2.sh.%A_%a.stderr
...
echo python $SCRIPTS/3_Reduplicate.py $QUALFILE $mRNA $CDHITFILE $REREP/$PREFIX"_mRNA.fastq"
...
echo fastqc $PREFIX"_mRNA.fastq"
