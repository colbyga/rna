...
#SBATCH -c 2
#SBATCH -t 2-0:0:0 
#SBATCH -o /global/project/hpcg1504/rna/logs_gc/gc_run_vsearch3.sh.%A_%a.stdout
#SBATCH -e /global/project/hpcg1504/rna/logs_gc/slurm/gc_run_vsearch3.sh.%A_%a.stderr
...
FASTQCDIR=$BASEDIR/analysis_gc/fastqc_vsearch3
...
# actual cmd
vsearch --threads 2 --fastq_mergepairs $FILENAME1 --reverse $FILENAME2 --fastqout $VSEARCHDIR/$PREFIX --fastqout_notmerged_fwd $VSEARCHDIR/$PREFIX_R1.notmerged.fastq --fastqout_notmerged_rev $VSEARCHDIR/$PREFIX_R2.notmerged.fastq --fastq_minlen 60 --fastq_minmergelen 70 

#echo to output file 
echo vsearch --threads 2 --fastq_filter $VSEARCHDIR/$PREFIX --fastq_maxee 2.0 --fastqout $VSEARCHDIR/$PREFIXQUAL
# actual cmd
vsearch --threads 2 --fastq_filter $VSEARCHDIR/$PREFIX --fastq_maxee 2.0 --fastq_minlen 60 --fastq_maxlen 120 --fastqout $VSEARCHDIR/$PREFIXQUAL
#if this worked: all fastqc outputs should be a max of 120 bp long
