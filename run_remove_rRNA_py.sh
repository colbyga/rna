...
#SBATCH -c 2
#SBATCH -t 4-0:0:0 
#SBATCH -o /global/project/hpcg1504/rna/logs_gc/gc_run_rRNA_remove.python.%A_%a.stdout
#SBATCH -e /global/project/hpcg1504/rna/logs_gc/slurm/gc_rRNA_remove.python.%A_%a.stderr
