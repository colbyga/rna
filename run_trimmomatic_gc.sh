...
RUNCODE="java -jar $EBROOTTRIMMOMATIC/trimmomatic-0.36.jar PE -phred33 -threads $SLURM_JOB_CPUS_PER_NODE -trimlog $TRIMDIR/$PREFIX.log $FILENAME1 $FILENAME2 -baseout $TRIMDIR/$PREFIX ILLUMINACLIP:$BASEDIR/rawdata/TruSeq3-PE-2.fa:3:30:8:8:true LEADING:3 TRAILING:3 SLIDINGWINDOW:4:20 MINLEN:36 CROP:120 HEADCROP:30 AVGQUAL:20"
